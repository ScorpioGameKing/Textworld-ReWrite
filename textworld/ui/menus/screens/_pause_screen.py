...
from textworld.ui.menus.premades import LeftSavePanel, RightSavePanel, BottomSavePanel, TopSavePanel
...
class PauseScreen():
    ...
    top_panel: TopSavePanel
    bottom_panel: BottomSavePanel
    ...
    def __init__(self, window):
        ...
        self.top_panel = TopSavePanel(self._window, Coords(240, 40), Size(370, 800), self._window.colors["fg"], self._window.colors["bg"], slide_dir='up', slide_speed=6)
        self.bottom_panel = BottomSavePanel(self._window, Coords(240, 430), Size(200, 800), self._window.colors["fg"], self._window.colors["bg"], slide_dir='down')
